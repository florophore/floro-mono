...
@injectable()
export default class OrgApiKeyGuard extends GuardResolverHook<
  unknown,
...
> {
  ...
  public run = runWithHooks(
    ...
    async (_, args: { apiKeyId: string; organizationId: string }, context) => {
      ...
      if (apiKey.keyType != "org_key" || apiKey.organizationId != args.organizationId) {
        return {
          __typename: "UnAuthenticatedError",
          type: "UNAUTHENTICATED_ERROR",
          message: "Unauthenticated request",
