...
export interface Props {
  page: "local-api" | "local-webhook" | "remote-api" | "remote-webhook";
...
const UserApiController = (props: Props) => {
...
export default React.memo(UserApiController);
