...
const PluginPrivateSelect = (props: Props): React.ReactElement => {
    ...
    <div>
      <Container>
        <Row>
          ...
          <TextWrap>
            <Subtext>
              {"Anyone can use this plugin in their repository."}
            </Subtext>
          </TextWrap>
        </Row>
        <Row>
          ...
          <TextWrap>
            <Subtext>
              {"This plugin will only ever be accessible to repositories owned by this account."}
            </Subtext>
          </TextWrap>
        </Row>
      </Container>
...
export default React.memo(PluginPrivateSelect);
