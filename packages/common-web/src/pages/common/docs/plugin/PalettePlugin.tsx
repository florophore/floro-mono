...
const PalettePlugin = () => {
  ...
  const title = usePlainText("meta_tags.palette_plugin");
  ...
  const article = useRichText(
    "plugin_docs.palette_plugin",
    {
      ...
      demoVideo: (
        <YTIframe
          src="https://www.youtube.com/embed/j6E0Ur8VygA"
...
export default React.memo(PalettePlugin);