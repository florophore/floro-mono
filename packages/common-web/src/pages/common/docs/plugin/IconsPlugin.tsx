...
const IconsPlugin = () => {
  ...
  const title = usePlainText("meta_tags.icons_plugin");
  ...
  const article = useRichText(
    "plugin_docs.icons_plugin",
    {
      ...
      demoVideo: (
        <YTIframe
          src="https://www.youtube.com/embed/piTOUruPvho"
...
export default React.memo(IconsPlugin);