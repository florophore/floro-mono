...
const TextPlugin = () => {
  ...
  const title = usePlainText("meta_tags.text_plugin");
  ...
  const article = useRichText(
    "plugin_docs.text_plugin",
    {
      ...
      subTitle: function (
        content: ReactElement<any, string | JSXElementConstructor<any>>,
        phrase: keyof PhraseKeys["plugin_docs.text_plugin"]["styledContents"]
      ): ReactElement<any, string | JSXElementConstructor<any>> {
        if (phrase == "features") {
      ...
      rnDemoVideo: (
        <YTIframe
          src="https://www.youtube.com/embed/Om-k08GDoZ4"
      ...
      tutorial1: (
        <YTIframe
          src="https://www.youtube.com/embed/zfrCR9Xtqeo"
          allowFullScreen
        />
      ),
      tutorial2: (
        <YTIframe
          src="https://www.youtube.com/embed/1HCKwg60zBg"
          allowFullScreen
        />
      ),
      tutorial3: (
        <YTIframe
          src="https://www.youtube.com/embed/UfixBHN_-H8"
          allowFullScreen
        />
      ),
      tutorial4: (
        <YTIframe
          src="https://www.youtube.com/embed/fYm6AOvhUHE"
          allowFullScreen
        />
      ),
      tutorial5: (
        <YTIframe
          src="https://www.youtube.com/embed/OMyneNGZPyc"
          allowFullScreen
        />
      ),
      tutorial6: (
        <YTIframe
          src="https://www.youtube.com/embed/zFrQ6kf6Sew"
          allowFullScreen
        />
      ),
      tutorial7: (
        <YTIframe
          src="https://www.youtube.com/embed/WMHg_PNvP1A"
          allowFullScreen
        />
      ),
      tutorial8: (
        <YTIframe
          src="https://www.youtube.com/embed/3LBRy7F0LjY"
          allowFullScreen
        />
      ),
      tutorial9: (
        <YTIframe
          src="https://www.youtube.com/embed/8LnD7SJniD8"
          allowFullScreen
        />
      ),
      tutorial10: (
        <YTIframe
          src="https://www.youtube.com/embed/CAQt4IyulKg"
          allowFullScreen
        />
      ),
    },
...
export default React.memo(TextPlugin);