...
import { WebhookKey, useCreateUserWebhookKeyMutation } from "@floro/graphql-schemas/src/generated/main-client-graphql";
...
const CreateRemoteUserWebhookDomainModal = (props: Props) => {
  ...
  const [createKey, createKeyMutation] = useCreateUserWebhookKeyMutation();
...
;
  ...
  useEffect(() => {
    if (createKeyMutation.data?.createUserWebhookKey?.__typename == "UserWebhookKeySuccess") {
      props.onDismissModal();
    }
  }, [createKeyMutation.data?.createUserWebhookKey?.__typename]);
...
export default React.memo(CreateRemoteUserWebhookDomainModal);
