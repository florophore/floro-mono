...
const ConfirmMergeWIPModal = (props: Props) => {
  ...
  const title = useMemo(() => {
    return (
      <HeaderContainer>
        <HeaderTitle>{"pull warning"}</HeaderTitle>
      </HeaderContainer>
    );
  }, []);
    ...
    >
      <ContentContainer>
        <TopContentContainer>
          ...
          <PromptText>
            {`You can pull but your current changes will be merged with the latest commit. This should not cause any problems but will alter your uncommitted changes.`}
          </PromptText>
        </TopContentContainer>
...
export default React.memo(ConfirmMergeWIPModal);
