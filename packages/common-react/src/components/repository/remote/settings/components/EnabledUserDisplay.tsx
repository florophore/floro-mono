...
const EnabledUserDisplay = (props: Props) => {
  return (
    <Container>
      <LabelContainer>
      ...
      <MainContainer>
        <LeftContainer>
          ...
          {props.enabledUsers.map((user, index) => {
            ...
            return (
              <PillContainer key={index}>
                <div style={{ marginRight: 8 }}>
                  <UserProfilePhoto size={24} user={user} offlinePhoto={null} />
                </div>
...
export default React.memo(EnabledUserDisplay);
