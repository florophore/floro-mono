...
const CanCreateMergeRequestsRolesModal = (props: Props) => {
  ...
  useEffect(() => {
    if (
      updateRolesResult?.data?.updateAnyoneCanCreateMergeRequestsRoles?.__typename ==
  ...
  return (
    <RootLongModal
      ...
      headerChildren={
        <HeaderWrapper>
          <FloroHeaderTitle>{"create merge request roles"}</FloroHeaderTitle>
        </HeaderWrapper>
      }
    >
      <ContentContainer>
...
export default React.memo(CanCreateMergeRequestsRolesModal);
