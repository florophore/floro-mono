...
const DomainVerifySucceededModal = (props: Props) => {
  const title = useMemo(() => {
    return (
      <HeaderContainer>
        <HeaderTitle>{"domain verified"}</HeaderTitle>
      </HeaderContainer>
    );
  }, []);
  ...
  return (
    ...
    >
      <ContentContainer>
        <TopContentContainer>
          <WarningIcon src={TealHexagonWarningLight} />
          <PromptText>
...
export default React.memo(DomainVerifySucceededModal);
