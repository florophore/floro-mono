...
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues.variableRef<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues.variableRef<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues.variableRef<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues.variableRef<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.conditionals'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.conditionals']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.conditionals']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.conditionals'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.defaultValue'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.defaultValue']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.defaultValue']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>.defaultValue'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkDisplayValue'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkDisplayValue']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkDisplayValue']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkDisplayValue'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkHrefValue'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkHrefValue']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkHrefValue']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>.linkHrefValue'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>.displayValue'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>.displayValue']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>.displayValue']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>.displayValue'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>.displayValue'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>.displayValue']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>.displayValue']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>.displayValue'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>.mockValues'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>.localeRules.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>.localeRules.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>.localeRules.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests.description<?>'], doSave?: boolean) => void|(() => void), () => void];
...
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables.linkName<?>.translations'], doSave?: boolean) => void|(() => void), () => void];
...
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>.localeTests'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants.name<?>'], doSave?: boolean) => void|(() => void), () => void];
...
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections.name<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents.name<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.contentVariables'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.description'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.description']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.description']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.description'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.interpolationVariants'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.linkVariables'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseSections'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.phraseTranslations'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styleClasses'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.styledContents'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.testCases'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>.variables'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).terms.id<?>.localizedTerms.id<?>'], defaultData?: SchemaTypes['$(text).terms.id<?>.localizedTerms.id<?>']): [SchemaTypes['$(text).terms.id<?>.localizedTerms.id<?>']|null, (t: SchemaTypes['$(text).terms.id<?>.localizedTerms.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).localeSettings.locales.localeCode<?>'], defaultData?: SchemaTypes['$(text).localeSettings.locales.localeCode<?>']): [SchemaTypes['$(text).localeSettings.locales.localeCode<?>']|null, (t: SchemaTypes['$(text).localeSettings.locales.localeCode<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>.phrases'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>.phrases']): [SchemaTypes['$(text).phraseGroups.id<?>.phrases']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>.phrases'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).terms.id<?>.localizedTerms'], defaultData?: SchemaTypes['$(text).terms.id<?>.localizedTerms']): [SchemaTypes['$(text).terms.id<?>.localizedTerms']|null, (t: SchemaTypes['$(text).terms.id<?>.localizedTerms'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).localeSettings.locales'], defaultData?: SchemaTypes['$(text).localeSettings.locales']): [SchemaTypes['$(text).localeSettings.locales']|null, (t: SchemaTypes['$(text).localeSettings.locales'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups.id<?>'], defaultData?: SchemaTypes['$(text).phraseGroups.id<?>']): [SchemaTypes['$(text).phraseGroups.id<?>']|null, (t: SchemaTypes['$(text).phraseGroups.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).terms.id<?>'], defaultData?: SchemaTypes['$(text).terms.id<?>']): [SchemaTypes['$(text).terms.id<?>']|null, (t: SchemaTypes['$(text).terms.id<?>'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).localeSettings'], defaultData?: SchemaTypes['$(text).localeSettings']): [SchemaTypes['$(text).localeSettings']|null, (t: SchemaTypes['$(text).localeSettings'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).phraseGroups'], defaultData?: SchemaTypes['$(text).phraseGroups']): [SchemaTypes['$(text).phraseGroups']|null, (t: SchemaTypes['$(text).phraseGroups'], doSave?: boolean) => void|(() => void), () => void];
export function useFloroState(query: PointerTypes['$(text).terms'], defaultData?: SchemaTypes['$(text).terms']): [SchemaTypes['$(text).terms']|null, (t: SchemaTypes['$(text).terms'], doSave?: boolean) => void|(() => void), () => void];
