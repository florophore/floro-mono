...
const SourceText = (props: Props) => {
  ...
  const stickyStyles = useMemo((): any => {
    if (showExtend) {
      return {
        minHeight: 80, overflowY: 'initial', height: '100%'
      }
    }
    return {
      minHeight: 80, height: 80, maxHeight: 800, overflowY: 'scroll'
    }
...
export default React.memo(SourceText);
