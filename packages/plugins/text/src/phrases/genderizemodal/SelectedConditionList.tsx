...
interface Props {
  label: string;
  potentialConditions: Array<GenderCondition>;
  selectedConditions: Array<GenderCondition>;
  onSelectCondition: (condition: GenderCondition) => void;
  onUnSelectCondition: (condition: GenderCondition) => void;
  varName: string;
