...
import UserRemoteWebhook from '@floro/common-react/src/components/user_api/UserRemoteWebhook';

const UserRemoteWebhookHome = () => {
...
export default React.memo(UserRemoteWebhookHome);