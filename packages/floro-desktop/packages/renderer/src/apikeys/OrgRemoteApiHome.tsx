...
import OrganizationRemoteApi from '@floro/common-react/src/components/organization_api/OrganizationRemoteApi';

const OrgRemoteApiHome = () => {
...
export default React.memo(OrgRemoteApiHome);
