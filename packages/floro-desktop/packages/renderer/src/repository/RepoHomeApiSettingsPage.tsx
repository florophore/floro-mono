...
import { Repository, useFetchRepositoryWithApiSettingsQuery, useRepositoryUpdatesSubscription} from '@floro/graphql-schemas/src/generated/main-client-graphql';
...
export default React.memo(RepoHomeApiSettingsPage);