...
import {FetchRepositoryByNameDocument, Repository, useFetchRepositoryByNameQuery, useFetchRepositoryWithSettingsQuery, useRepositoryUpdatesSubscription} from '@floro/graphql-schemas/src/generated/main-client-graphql';
...
const RepoHomeSettingsPage = () => {
  ...
  const {data, loading} = useFetchRepositoryWithSettingsQuery({
    variables: {
      ownerHandle,
      repoName,
    },
